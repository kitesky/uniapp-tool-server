...
type toolDuHouGan struct {
	Message     string
	FormSchemas []*schemas.ToolFormItem
}

func NewToolDuHouGan() *toolDuHouGan {
	return &toolDuHouGan{
...
func (t *toolDuHouGan) GetMessage() (result string) {
	return t.Message
}

func (t *toolDuHouGan) GetFormSchemas() (result []*schemas.ToolFormItem) {
	return t.FormSchemas
}

func (t *toolDuHouGan) RequestHandler(message string) (result *schemas.ToolHandlerResponse, err error) {
