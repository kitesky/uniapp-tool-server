...
// 测试
type toolGongZhongHao struct {
	Message     string
	FormSchemas []*schemas.ToolFormItem
}

func NewToolGongZhongHao() *toolGongZhongHao {
	return &toolGongZhongHao{
		Message: "写一篇微信公众号文章,主题:{title},内容风格{style},字数限制:{size},其他要求:{requirement}",
		FormSchemas: []*schemas.ToolFormItem{
			{
...
func (t *toolGongZhongHao) GetMessage() (result string) {
	return t.Message
}

func (t *toolGongZhongHao) GetFormSchemas() (result []*schemas.ToolFormItem) {
	return t.FormSchemas
}

func (t *toolGongZhongHao) RequestHandler(message string) (result *schemas.ToolHandlerResponse, err error) {
